    ...
    <div style={styles.slideOutPanel}>
      <div style={styles.slideOutHeader}>
        <div style={styles.slideOutHeaderLeft}>
          <div style={styles.slideOutTitle}>
        ...
        <button style={styles.slideOutClose} onClick={onClose}>
          ✕
        </button>
      </div>
              ...
              return (
                ...
                >
                  <div style={styles.waypointHeader}>
                    <span style={styles.waypointKm}>
                      KM {Math.round(wp.distanceFromStart || 0)}
                    </span>
                    ...
                    <span style={styles.waypointExpand}>
                      {isExpanded ? "▲" : "▼"}
                    </span>
                  </div>
                  ...
                  {isExpanded && interpretation && (
                    <div style={styles.waypointDetails}>
                      ...
                      {wp.fuelImpact?.extraFuelPer100km != null &&
                        wp.fuelImpact.extraFuelPer100km > 0 && (
                          <div style={styles.fuelBanner}>
                            ...
                            <div style={styles.fuelContent}>
                              ...
                              <span style={styles.fuelValue}>
                                +{wp.fuelImpact.extraFuelPer100km} L/100km
                              </span>
                            </div>
                          </div>
                        )}

                      <div style={styles.waypointSummary}>
                        {interpretation.summary}
                      </div>
                      <div style={styles.waypointRecommendation}>
                      ...
                      <div style={styles.waypointSpeed}>
                        ⚡ Max Safe Speed: {wp.maxSafeSpeed || "N/A"} km/h
                      </div>
                    </div>
                  )}
                </div>
