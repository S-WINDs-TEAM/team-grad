                        ...
                        return (
                            <div key={v._id} style={{ position: 'relative' }}>
                                    ...
                                    <div style={{ flex: 1, minWidth: 0 }}>
                                        ...
                                        <div
                                            style={{
                                                ...
                                                cursor: 'pointer',
                                                color: hasDriver ? theme.textSecondary : theme.accentOrange,
                                            ...
                                            title={hasDriver ? `Click to change driver` : `Click to assign a driver`}
                                        >
                                ...
                                {isDropdownOpen && (
                                    ...
                                    >
                                        <div style={{ fontSize: '11px', color: theme.textMuted, marginBottom: '6px', fontWeight: '600' }}>
                                            Assign Driver:
                                        </div>
                                        {hasDriver && (
                                            <button
                                        ...
                                        {drivers.length === 0 && (
                                            <div style={{ fontSize: '11px', color: theme.textMuted, padding: '4px' }}>
                                        ...
                                        {drivers.map((d) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    onClick={() => handleDriverDropdownSelect(v._id, d._id)}
                                                    disabled={assigningDriver === v._id}
                                                >
                                                    👤 {d.name}
