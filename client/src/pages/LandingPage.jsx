    ...
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        <h1 style={styles.heroTitle}>
          Navigate Smarter. <span style={styles.heroAccent}>Arrive Safer.</span>
        </h1>
        <p style={styles.heroSub}>
          Real-time weather intelligence and smart routing
          <br />
          for every journey and every fleet.
        </p>
        ...
        <div style={styles.cardsRow}>
          ...
          >
            <div
              style={{ ...styles.cardIcon, background: "rgba(37,99,235,0.15)" }}
            >
              🚗
            </div>
            <h2 style={styles.cardTitle}>Individual Driver</h2>
            <p style={styles.cardDesc}>
              Get personalized weather alerts, smarter routes, and real-time
              road conditions for your daily drive.
            </p>
          ...
          >
            ...
            <p style={styles.cardDesc}>
              Monitor your fleet in real time, optimize operations, and keep
              every driver and vehicle safe.
            </p>
            <ul style={styles.featureList}>
              {[
                "Live fleet tracking",
