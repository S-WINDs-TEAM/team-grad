...
<<<<<<< HEAD
=======
const registerCompanyApi = (data) => axiosInstance.post('/auth/register-company', data);
>>>>>>> origin/ElSayed
...
const acceptInviteApi = (token, data) => axiosInstance.post(`/auth/invite/${token}/accept`, data);

const uploadProfilePhotoApi = (formData) => axiosInstance.post('/auth/me/photo', formData, {
