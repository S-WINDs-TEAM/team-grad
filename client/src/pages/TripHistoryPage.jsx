                            ...
                            {trips.map((trip, index) => (
                                <div key={trip._id || index} style={styles.tripCard}>
                                    ...
                                    <div style={styles.tripDetails}>
                                        <span>📅 {formatDate(trip.departureTime || trip.createdAt)}</span>
...
const styles = {
    ...
    tripRoute: {
        ...
        color: theme.textPrimary, fontSize: '15px', fontWeight: '600',
    },
    ...
    riskBadge: {
        ...
        borderRadius: '6px', border: '1px solid', background: 'transparent',
    ...
    viewBtn: {
        alignSelf: 'flex-start', padding: '6px 16px', background: 'transparent',
        border: `1px solid ${theme.borderDefault}`, borderRadius: '8px',
        color: theme.accentBlue, fontSize: '13px', cursor: 'pointer',
    },
    // Pagination styles
    paginationWrapper: {
        display: 'flex', justifyContent: 'center', alignItems: 'center',
        gap: '24px', marginTop: '32px', paddingTop: '24px',
    ...
    paginationInfo: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' },
    paginationText: { fontSize: '14px', fontWeight: '600', color: theme.textPrimary },
