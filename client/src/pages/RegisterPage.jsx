...
const RegisterPage = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.success(
        accountType === "company"
          ? "company registered, welcome aboard"
          : "acc created, welcome aboard",
      );
          ...
          <h1 style={styles.leftTitle}>
            {accountType === "company" ? (
              <>
                Manage Your Fleet.
                <br />
                <span style={{ color: theme.accentGreen }}>Stay Ahead.</span>
              </>
            ) : (
              <>
                Join S-WINDs.
                <br />
                <span style={{ color: theme.accentBlue }}>Drive Smart.</span>
              </>
            )}
          </h1>
            ...
            {accountType === "company" ? (
              <>
                ...
                <div style={styles.field}>
                  ...
                  />
                  {errors.adminName && (
                    <span style={styles.error}>{errors.adminName.message}</span>
                  )}
                </div>
              </>
            ) : (
